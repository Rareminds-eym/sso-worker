/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 0d6d7b7ea508c2fba6bd6e6e70531e2b)
...
interface __BaseEnv_Env {
	...
	EMAIL_SERVICE: Service /* entrypoint EmailService from shared-email-api */;
	SKILLPASSPORT: Fetcher /* skill-passport-portal */;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "ALLOWED_ORIGINS" | "SUPABASE_URL" | "SUPABASE_SERVICE_ROLE_KEY" | "JWT_PRIVATE_KEY" | "JWT_PUBLIC_KEY" | "JWT_KID" | "EMAIL_API_KEY" | "ALLOWED_APP_URLS" | "SKILLPASSPORT_URL">> {}
}
