...
CREATE OR REPLACE FUNCTION "public"."expire_old_subscriptions"() RETURNS TABLE("count" integer)
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
DECLARE
...
CREATE TABLE IF NOT EXISTS "public"."addon_catalog" (
    ...
    CONSTRAINT "addon_catalog_category_check" CHECK (("category" = ANY (ARRAY['capacity'::"text", 'branding'::"text", 'content'::"text", 'learning'::"text", 'assessments'::"text", 'certificates'::"text", 'analytics'::"text", 'integrations'::"text", 'security'::"text", 'support'::"text"])))
);
...
ALTER TABLE "public"."bundle_purchases" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."events" (
    ...
    "razorpay_payment_id" "text",
    "created_at" timestamp with time zone DEFAULT "now"(),
    CONSTRAINT "events_status_check" CHECK (("status" = ANY (ARRAY['received'::"text", 'processing'::"text", 'completed'::"text", 'failed'::"text", 'skipped'::"text"])))
);
...
CREATE TABLE IF NOT EXISTS "public"."plans" (
    ...
    "applicable_entities" "text"[] DEFAULT '{}'::"text"[] NOT NULL,
    "pricing_matrix" "jsonb" DEFAULT '{}'::"jsonb" NOT NULL,
...
CREATE TABLE IF NOT EXISTS "public"."subscriptions" (
    ...
    "updated_at" timestamp with time zone DEFAULT "now"(),
    "product_id" "uuid",
    CONSTRAINT "subscriptions_status_check" CHECK (("status" = ANY (ARRAY['pending'::"text", 'active'::"text", 'paused'::"text", 'cancelled'::"text", 'expired'::"text", 'grace_period'::"text"])))
);
...
CREATE TABLE IF NOT EXISTS "public"."transactions" (
    ...
    "status" "text" DEFAULT 'pending'::"text" NOT NULL,
    "transaction_type" "text" DEFAULT 'subscription'::"text",
    "payment_method" "text",
    "organization_type" "text",
    "seat_count" integer DEFAULT 1,
    "is_bulk_purchase" boolean DEFAULT false,
    ...
    CONSTRAINT "transactions_transaction_type_check" CHECK (("transaction_type" = ANY (ARRAY['subscription'::"text", 'upgrade'::"text", 'addon'::"text", 'bundle'::"text", 'org'::"text", 'event'::"text"])))
);
...
ALTER TABLE ONLY "public"."addon_catalog"
    ADD CONSTRAINT "addon_catalog_unique_feature" UNIQUE ("product_id", "feature_key");
...
ALTER TABLE ONLY "public"."bundle_features"
    ADD CONSTRAINT "bundle_features_unique" UNIQUE ("bundle_id", "feature_key");



ALTER TABLE ONLY "public"."bundle_purchases"
...
ALTER TABLE ONLY "public"."bundles"
    ADD CONSTRAINT "bundles_unique_slug" UNIQUE ("product_id", "slug");
...
CREATE INDEX "idx_addon_catalog_category" ON "public"."addon_catalog" USING "btree" ("category");



CREATE INDEX "idx_addon_catalog_feature_key" ON "public"."addon_catalog" USING "btree" ("feature_key");



CREATE INDEX "idx_addon_catalog_product_id" ON "public"."addon_catalog" USING "btree" ("product_id");



CREATE INDEX "idx_addon_purchases_feature_key" ON "public"."addon_purchases" USING "btree" ("feature_key");



CREATE INDEX "idx_addon_purchases_razorpay_order" ON "public"."addon_purchases" USING "btree" ("razorpay_order_id");
...
CREATE INDEX "idx_addon_purchases_user_id" ON "public"."addon_purchases" USING "btree" ("user_id");
...
CREATE INDEX "idx_bundle_purchases_bundle_id" ON "public"."bundle_purchases" USING "btree" ("bundle_id");



CREATE INDEX "idx_bundle_purchases_razorpay_order" ON "public"."bundle_purchases" USING "btree" ("razorpay_order_id");



CREATE INDEX "idx_bundle_purchases_status" ON "public"."bundle_purchases" USING "btree" ("status");



CREATE INDEX "idx_bundle_purchases_user_id" ON "public"."bundle_purchases" USING "btree" ("user_id");



CREATE INDEX "idx_bundles_product_id" ON "public"."bundles" USING "btree" ("product_id");
...
CREATE INDEX "idx_events_user" ON "public"."events" USING "btree" ("user_id") WHERE ("user_id" IS NOT NULL);
...
CREATE INDEX "idx_plans_product_id" ON "public"."plans" USING "btree" ("product_id");
...
CREATE UNIQUE INDEX "idx_subscriptions_active_user" ON "public"."subscriptions" USING "btree" ("user_id") WHERE (("status" = ANY (ARRAY['active'::"text", 'pending'::"text"])) AND ("is_organization_subscription" IS NOT TRUE) AND ("is_bulk_purchase" IS NOT TRUE));



CREATE INDEX "idx_subscriptions_org" ON "public"."subscriptions" USING "btree" ("organization_id") WHERE ("organization_id" IS NOT NULL);
...
CREATE INDEX "idx_subscriptions_razorpay_order" ON "public"."subscriptions" USING "btree" ("razorpay_order_id") WHERE ("razorpay_order_id" IS NOT NULL);
...
CREATE INDEX "idx_transactions_razorpay_order" ON "public"."transactions" USING "btree" ("razorpay_order_id") WHERE ("razorpay_order_id" IS NOT NULL);



CREATE INDEX "idx_transactions_razorpay_payment" ON "public"."transactions" USING "btree" ("razorpay_payment_id") WHERE ("razorpay_payment_id" IS NOT NULL);
...
CREATE INDEX "idx_transactions_subscription" ON "public"."transactions" USING "btree" ("subscription_id");
...
CREATE UNIQUE INDEX "idx_unique_active_subscription" ON "public"."subscriptions" USING "btree" ("user_id") WHERE (("status" = ANY (ARRAY['active'::"text", 'pending'::"text"])) AND ("is_organization_subscription" IS NOT TRUE) AND ("is_bulk_purchase" IS NOT TRUE));
...
CREATE OR REPLACE TRIGGER "trg_auto_set_cancelled_at" BEFORE UPDATE ON "public"."subscriptions" FOR EACH ROW EXECUTE FUNCTION "public"."auto_set_cancelled_at"();



CREATE OR REPLACE TRIGGER "trg_check_duplicate_active" BEFORE INSERT ON "public"."subscriptions" FOR EACH ROW EXECUTE FUNCTION "public"."check_duplicate_active_subscription"();
...
CREATE OR REPLACE TRIGGER "trg_validate_status_transition" BEFORE UPDATE ON "public"."subscriptions" FOR EACH ROW EXECUTE FUNCTION "public"."validate_subscription_status_transition"();



ALTER TABLE ONLY "public"."addon_catalog"
    ADD CONSTRAINT "addon_catalog_product_id_fkey" FOREIGN KEY ("product_id") REFERENCES "public"."products"("id");



ALTER TABLE ONLY "public"."addon_purchases"
    ADD CONSTRAINT "addon_purchases_product_id_fkey" FOREIGN KEY ("product_id") REFERENCES "public"."products"("id");
...
ALTER TABLE ONLY "public"."bundle_purchases"
    ADD CONSTRAINT "bundle_purchases_bundle_id_fkey" FOREIGN KEY ("bundle_id") REFERENCES "public"."bundles"("id");



ALTER TABLE ONLY "public"."bundle_purchases"
    ADD CONSTRAINT "bundle_purchases_product_id_fkey" FOREIGN KEY ("product_id") REFERENCES "public"."products"("id");



ALTER TABLE ONLY "public"."bundle_purchases"
    ADD CONSTRAINT "bundle_purchases_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id");
...
CREATE POLICY "addon_catalog_public_read" ON "public"."addon_catalog" FOR SELECT USING (("is_active" = true));
...
CREATE POLICY "addon_purchases_deny_anon" ON "public"."addon_purchases" TO "anon" USING (false);



CREATE POLICY "addon_purchases_service_only" ON "public"."addon_purchases" TO "service_role" USING (true);
...
CREATE POLICY "bundle_features_public_read" ON "public"."bundle_features" FOR SELECT USING (true);



CREATE POLICY "bundle_features_service_write" ON "public"."bundle_features" USING (true);
...
CREATE POLICY "bundle_purchases_deny_anon" ON "public"."bundle_purchases" TO "anon" USING (false);



CREATE POLICY "bundle_purchases_service_only" ON "public"."bundle_purchases" TO "service_role" USING (true);
...
CREATE POLICY "bundles_service_write" ON "public"."bundles" USING (true);
...
CREATE POLICY "events_deny_anon" ON "public"."events" TO "anon" USING (false) WITH CHECK (false);



CREATE POLICY "events_service_only" ON "public"."events" TO "service_role" USING (true) WITH CHECK (true);
...
CREATE POLICY "plans_service_write" ON "public"."plans" TO "service_role" USING (true) WITH CHECK (true);
...
CREATE POLICY "subscriptions_deny_anon" ON "public"."subscriptions" TO "anon" USING (false) WITH CHECK (false);



CREATE POLICY "subscriptions_service_only" ON "public"."subscriptions" TO "service_role" USING (true) WITH CHECK (true);
...
CREATE POLICY "transactions_deny_anon" ON "public"."transactions" TO "anon" USING (false) WITH CHECK (false);



CREATE POLICY "transactions_service_only" ON "public"."transactions" TO "service_role" USING (true) WITH CHECK (true);
...
GRANT ALL ON TABLE "public"."bundle_purchases" TO "anon";
GRANT ALL ON TABLE "public"."bundle_purchases" TO "authenticated";
GRANT ALL ON TABLE "public"."bundle_purchases" TO "service_role";
