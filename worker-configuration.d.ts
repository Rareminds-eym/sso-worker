/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 5369b1d7f8895d91b6f0ac358d83711b)
// Runtime types generated with workerd@1.20260521.1 2026-05-25 nodejs_compat
interface __BaseEnv_Env {
	RATE_LIMIT_KV: KVNamespace;
	ALLOWED_ORIGINS: "http://localhost:3000,http://localhost:5173,http://localhost:8788,https://*.rareminds.in,http://127.0.0.1:8788";
	SUPABASE_URL: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ALLOWED_ORIGINS" | "SUPABASE_URL" | "SUPABASE_SERVICE_ROLE_KEY" | "JWT_PRIVATE_KEY" | "JWT_PUBLIC_KEY" | "JWT_KID" | "EMAIL_API_KEY" | "ALLOWED_APP_URLS">> {}
}
